...
namespace TNT.Boilerplates.Diagnostic
{
    public class RateMonitor : IRateMonitor, IDisposable
    {
        ...
        {
            _categoryMap = new ConcurrentDictionary<string, CategoryCount>();
            _logger = logger;
            _reportTimer = new System.Timers.Timer(interval: 5000);
        ...
        class CategoryCount
        {
            ...
            {
                Category = category;
                CountPerSecond = new ConcurrentDictionary<long, CountRef>();
            }
